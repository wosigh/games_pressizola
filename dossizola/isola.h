...
#define TREMBLE_NB 6			// Nombre d'itérations du tremblement de la grille
...
typedef struct {
	...
	SDL_Rect Scores[2];
	POLICE police1, police2, police3, police1big, police2big, police3big;	// Polices pour l'affichage de caractères
